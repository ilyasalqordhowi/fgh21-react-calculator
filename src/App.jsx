    ...
    <div className="flex flex-col m-20  items-center">
      <div className="w-full max-w-[300px] h-[500px] bg-black flex flex-col rounded-2xl">
        ...
        <div className="grid grid-cols-4 gap-5 p-5">
          ...
          <button className="w-[55px] text-white bg-stone-800 h-[55px] rounded-full ">
            3
          </button>
          <button className="w-[55px] text-white bg-orange-600 h-[55px] rounded-full ">
            +
          </button>
          <button className="text-white bg-stone-800 h-[55px] rounded-full col-span-2 w-full  flex items-center pl-5 ">
            0
          </button>
          <button className="w-[55px] text-white bg-stone-800 h-[55px] rounded-full ">
            .
